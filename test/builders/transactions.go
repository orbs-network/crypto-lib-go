...
const TRIGGER_CONTRACT_NAME = "_Triggers"
const TRIGGER_METHOD_TRIGGER = "trigger"
	...
	return &TransactionBuilder{
		...
		builder: &protocol.SignedTransactionBuilder{
			Transaction: &protocol.TransactionBuilder{
				ProtocolVersion: DEFAULT_TEST_PROTOCOL_VERSION,
				VirtualChainId:  DEFAULT_TEST_VIRTUAL_CHAIN_ID,
				ContractName:    primitives.ContractName(TRIGGER_CONTRACT_NAME),
				MethodName:      primitives.MethodName(TRIGGER_METHOD_TRIGGER),
				Timestamp:       primitives.TimestampNano(time.Now().UnixNano()),
			},
		},
	}
